...
public:
	...
	virtual void				GetLightForPoint(const void* pos, bool bClamp) = 0;  //Vector

	// Traces the line and reports the material impacted as well as the lighting information for the impact point
	virtual void* TraceLineMaterialAndLighting(const void* start, const void* end, //IMaterial
	...
	virtual	void				Key_SetBinding(void* code, const char* pBinding) = 0;
	...
	virtual void		DebugDrawPhysCollide(const void* pCollide, void* pMaterial, matrix3x4_t& transform, const void* color) = 0;
	...
	virtual std::uint32_t   OnStorageDeviceAttached(void) = 0;
	...
	virtual std::uint32_t GetProtocolVersion() = 0;
